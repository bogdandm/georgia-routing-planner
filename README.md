...
- TiTiler for normal Sentinel RGB web tiles, with a worker-based browser COG
  rasterization fallback when the hosted renderer returns 429 or a CORS-opaque failure.
