...
* General map
    * Switch to 3D cause camera to be underground and then jump to random location. Move camera to required height before mode map mode switch
...
* URL sharing & state saving
    ...
    * For 3D mode share give another option in right click menu with camera position as url param
