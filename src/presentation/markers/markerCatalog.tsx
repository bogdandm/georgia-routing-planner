...
export const markerIconCatalog = [
  { key: 'place', label: 'Place', category: 'Places', svg: pinheadSvg0 },
  { key: 'flag', label: 'Flag', category: 'Places', svg: pinheadSvg1 },
  { key: 'home', label: 'Home', category: 'Places', svg: pinheadSvg2 },
  { key: 'parking', label: 'Parking', category: 'Places', svg: pinheadSvg3 },
  { key: 'apartment', label: 'Apartment', category: 'Places', svg: pinheadSvg4 },
  { key: 'business', label: 'Business', category: 'Places', svg: pinheadSvg5 },
  { key: 'cabin', label: 'Cabin', category: 'Places', svg: pinheadSvg6 },
  { key: 'cottage', label: 'Cottage', category: 'Places', svg: pinheadSvg7 },
  { key: 'city', label: 'City', category: 'Places', svg: pinheadSvg8 },
  { key: 'map', label: 'Map', category: 'Places', svg: pinheadSvg9 },
  { key: 'my-location', label: 'My location', category: 'Places', svg: pinheadSvg10 },
  { key: 'navigation', label: 'Navigation', category: 'Places', svg: pinheadSvg11 },
  { key: 'pin', label: 'Pin', category: 'Places', svg: pinheadSvg12 },
  { key: 'public', label: 'Public place', category: 'Places', svg: pinheadSvg13 },
  { key: 'school', label: 'School', category: 'Places', svg: pinheadSvg14 },
  { key: 'explore', label: 'Explore', category: 'Places', svg: pinheadSvg15 },
  { key: 'landscape', label: 'Landscape', category: 'Nature', svg: pinheadSvg16 },
  { key: 'forest', label: 'Forest', category: 'Nature', svg: pinheadSvg17 },
  { key: 'terrain', label: 'Terrain', category: 'Nature', svg: pinheadSvg18 },
  { key: 'water', label: 'Water', category: 'Nature', svg: pinheadSvg19 },
  { key: 'snow', label: 'Snow', category: 'Nature', svg: pinheadSvg20 },
  { key: 'beach', label: 'Beach', category: 'Nature', svg: pinheadSvg21 },
  { key: 'eco', label: 'Eco', category: 'Nature', svg: pinheadSvg22 },
  { key: 'grass', label: 'Grass', category: 'Nature', svg: pinheadSvg23 },
  { key: 'park', label: 'Park', category: 'Nature', svg: pinheadSvg24 },
  { key: 'spa', label: 'Spring', category: 'Nature', svg: pinheadSvg25 },
  { key: 'volcano', label: 'Volcano', category: 'Nature', svg: pinheadSvg26 },
  { key: 'waves', label: 'Waves', category: 'Nature', svg: pinheadSvg27 },
  { key: 'sunny', label: 'Sunny', category: 'Nature', svg: pinheadSvg28 },
  ...
  { key: 'pets', label: 'Pets', category: 'Activities', svg: pinheadSvg35 },
  { key: 'skiing', label: 'Skiing', category: 'Activities', svg: pinheadSvg36 },
  { key: 'kayaking', label: 'Kayaking', category: 'Activities', svg: pinheadSvg37 },
  {
    key: 'kitesurfing',
    label: 'Kitesurfing',
    category: 'Activities',
  ...
  { key: 'rowing', label: 'Rowing', category: 'Activities', svg: pinheadSvg40 },
  { key: 'sailing', label: 'Sailing', category: 'Activities', svg: pinheadSvg41 },
  { key: 'diving', label: 'Diving', category: 'Activities', svg: pinheadSvg42 },
  {
    key: 'skateboarding',
    label: 'Skateboarding',
    category: 'Activities',
  ...
  { key: 'sports', label: 'Sports', category: 'Activities', svg: pinheadSvg45 },
  { key: 'football', label: 'Football', category: 'Activities', svg: pinheadSvg46 },
  { key: 'surfing', label: 'Surfing', category: 'Activities', svg: pinheadSvg47 },
  { key: 'swimming', label: 'Swimming', category: 'Activities', svg: pinheadSvg48 },
  { key: 'running', label: 'Running', category: 'Activities', svg: pinheadSvg49 },
  {
    key: 'restaurant',
    label: 'Restaurant',
    category: 'Food & stay',
  ...
  { key: 'cafe', label: 'Cafe', category: 'Food & stay', svg: pinheadSvg51 },
  { key: 'hotel', label: 'Hotel', category: 'Food & stay', svg: pinheadSvg52 },
  { key: 'store', label: 'Store', category: 'Food & stay', svg: pinheadSvg53 },
  { key: 'bakery', label: 'Bakery', category: 'Food & stay', svg: pinheadSvg54 },
  { key: 'brunch', label: 'Brunch', category: 'Food & stay', svg: pinheadSvg55 },
  { key: 'camping', label: 'Camping', category: 'Food & stay', svg: pinheadSvg56 },
  { key: 'fast-food', label: 'Fast food', category: 'Food & stay', svg: pinheadSvg57 },
  { key: 'ice-cream', label: 'Ice cream', category: 'Food & stay', svg: pinheadSvg58 },
  { key: 'liquor', label: 'Liquor', category: 'Food & stay', svg: pinheadSvg59 },
  { key: 'bar', label: 'Bar', category: 'Food & stay', svg: pinheadSvg60 },
  { key: 'dining', label: 'Dining', category: 'Food & stay', svg: pinheadSvg61 },
  {
    key: 'drinking-water',
  ...
  { key: 'grocery', label: 'Grocery', category: 'Food & stay', svg: pinheadSvg63 },
  { key: 'shelter', label: 'Shelter', category: 'Food & stay', svg: pinheadSvg64 },
  { key: 'ramen', label: 'Ramen', category: 'Food & stay', svg: pinheadSvg65 },
  { key: 'seafood', label: 'Seafood', category: 'Food & stay', svg: pinheadSvg66 },
  { key: 'tapas', label: 'Tapas', category: 'Food & stay', svg: pinheadSvg67 },
  { key: 'camera', label: 'Camera', category: 'Landmarks', svg: pinheadSvg68 },
  { key: 'castle', label: 'Castle', category: 'Landmarks', svg: pinheadSvg69 },
  { key: 'church', label: 'Church', category: 'Landmarks', svg: pinheadSvg70 },
  { key: 'museum', label: 'Museum', category: 'Landmarks', svg: pinheadSvg71 },
  { key: 'monument', label: 'Monument', category: 'Landmarks', svg: pinheadSvg72 },
  { key: 'attraction', label: 'Attraction', category: 'Landmarks', svg: pinheadSvg73 },
  {
    key: 'celebration',
    label: 'Celebration',
    category: 'Landmarks',
  ...
  { key: 'deck', label: 'Deck', category: 'Landmarks', svg: pinheadSvg75 },
  { key: 'festival', label: 'Festival', category: 'Landmarks', svg: pinheadSvg76 },
  { key: 'fort', label: 'Fort', category: 'Landmarks', svg: pinheadSvg77 },
  { key: 'mosque', label: 'Mosque', category: 'Landmarks', svg: pinheadSvg78 },
  { key: 'synagogue', label: 'Synagogue', category: 'Landmarks', svg: pinheadSvg79 },
  {
    key: 'buddhist-temple',
  ...
  { key: 'theater', label: 'Theater', category: 'Landmarks', svg: pinheadSvg82 },
  { key: 'tour', label: 'Tour', category: 'Landmarks', svg: pinheadSvg83 },
  { key: 'villa', label: 'Villa', category: 'Landmarks', svg: pinheadSvg84 },
  { key: 'hospital', label: 'Hospital', category: 'Safety', svg: pinheadSvg85 },
  { key: 'medical', label: 'Medical', category: 'Safety', svg: pinheadSvg86 },
  { key: 'info', label: 'Info', category: 'Safety', svg: pinheadSvg87 },
  { key: 'warning', label: 'Warning', category: 'Safety', svg: pinheadSvg88 },
  { key: 'roadwork', label: 'Roadwork', category: 'Safety', svg: pinheadSvg89 },
  { key: 'blocked', label: 'Blocked', category: 'Safety', svg: pinheadSvg90 },
  { key: 'car-crash', label: 'Car crash', category: 'Safety', svg: pinheadSvg91 },
  { key: 'alert', label: 'Alert', category: 'Safety', svg: pinheadSvg92 },
  { key: 'danger', label: 'Danger', category: 'Safety', svg: pinheadSvg93 },
  { key: 'emergency', label: 'Emergency', category: 'Safety', svg: pinheadSvg94 },
  { key: 'engineering', label: 'Engineering', category: 'Safety', svg: pinheadSvg95 },
  {
  ...
  { key: 'safety', label: 'Safety', category: 'Safety', svg: pinheadSvg97 },
  { key: 'fire-station', label: 'Fire station', category: 'Safety', svg: pinheadSvg98 },
  { key: 'report', label: 'Report', category: 'Safety', svg: pinheadSvg99 },
  ...
  { key: 'car', label: 'Car', category: 'Transport', svg: pinheadSvg107 },
  { key: 'railway', label: 'Railway', category: 'Transport', svg: pinheadSvg108 },
  {
    key: 'electric-bike',
    label: 'Electric bike',
    category: 'Transport',
  ...
  { key: 'flight', label: 'Flight', category: 'Transport', svg: pinheadSvg110 },
  { key: 'fuel', label: 'Fuel', category: 'Transport', svg: pinheadSvg111 },
  { key: 'bike', label: 'Bike', category: 'Transport', svg: pinheadSvg112 },
  { key: 'snowmobile', label: 'Snowmobile', category: 'Transport', svg: pinheadSvg113 },
  { key: 'train', label: 'Train', category: 'Transport', svg: pinheadSvg114 },
