import type {
  ...
  TerrariumFilterPolicy,
  TerrariumRepairCounts,
  TerrariumTileGrid,
...
function decodeTerrariumElevation(red: number, green: number, blue: number): number {
  return red * 256 + green + blue / terrariumQuantization - terrariumOffsetMeters;
}

function encodeTerrariumElevation(
